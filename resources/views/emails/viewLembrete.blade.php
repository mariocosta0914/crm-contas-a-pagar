                ...
                <center style="">
                    ...
                    <table style="display: inline-block; margin: 0px auto; border-collapse: collapse; background-color: rgb(245, 243, 244);" width="600" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <tbody style="">
                            ...
                            <tr style="">
                                <td style="" align="center">
                                    <img alt="" style="display: block; height: 292px; width: 600px;" src="{{asset('img/bannerBottom.png')}}" border="0">
                                </td>
                            </tr>
                                            ...
                                            <tr style="">
                                                <td style="" width="100%" valign="top" align="left">
                                                    <p style="color: rgb(65, 64, 66); font-family: arial, helvetica, sans-serif; font-size: 15px; margin: 0px;  margin-bottom: 20px !important; line-height: 20px;">
                                                        <strong style="">{{ $boleto->Sacado }}</strong>,
                                                        <br style=""><br style="">
                                                        <img src="https://wireadmin.wirelink.com.br/api/registro-leitura/{{$boleto->CdRcd}}/2" alt="" width="1" height="1" style="display: none;">
                                                        Você tem datas mais importantes para lembrar do que o vencimento do seu
                                                        boleto.<br style=""><br style="">

                                                        Por isso, seguem as informações da sua <strong style="">fatura que tem
                                                            vencimento nos próximos dias:</strong>
                                            ...
                                            <tr style="">
                                                <td style="" width="100%" valign="top" align="left">
                                                    <p style="color: rgb(0, 0, 0); font-family: arial, helvetica, sans-serif; font-size: 13px; margin: 0px; line-height: 20px;">
                                                        ...
                                                        </strong> Nº <b>{{$boleto->NrPesEdr}}</b>, Bairro:
                                                        <b>{{$boleto->Bairro}}</b><br style="">
                                                        Código de barras: <strong style="">{{$boleto->codigo_barras}}</strong><br style="">
                                                        Data de vencimento: <strong style="">
                                                            {{ date( 'd/m/Y' , strtotime($boleto->vencimento))}}
                                                        </strong>
                                                        no valor de <b>R$ {{ number_format($boleto->Valor, 2, ',', '.') }} <br style="">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="100%" valign="top" align="left">
                                                    <p style="color:rgb(62,62,62);font-family:arial,helvetica,sans-serif;font-size:15px;margin:0px;line-height:20px">
                                                        Enviamos também a sua nota fiscal e o boleto para o endereço de e-mail cadastrado, mas você também pode utilizar o <strong>código de barras acima</strong> para adiantar seu pagamento.
                                                        <br><br>
                            ...
                            <tr style="" bgcolor="#FFFFFF">
                                <td style="">
                                    ...
                                    <p style="color: rgb(51, 51, 51); font-family: arial, helvetica, sans-serif; font-size: 11px; margin: 0px; text-align: justify;">
                                        ...
                                        Para enviar seus comentários, <a href="https://www.wirelink.com.br/" style="text-decoration: none; color: rgb(51, 51, 51);" target="_blank">clique aqui e fale conosco</a>. Se
                                        você já pagou sua
