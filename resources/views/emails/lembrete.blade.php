                                            ...
                                            <tr>
                                                <td width="100%" valign="top" align="left">
                                                    <p style="color: rgb(65, 64, 66); font-family: arial, helvetica, sans-serif; font-size: 15px; margin: 0px;  margin-bottom: 20px !important; line-height: 20px;">
                                                        <strong>{{ $cliente->Sacado }}</strong>,
                                                        <br><br>
                                                        <img rc="https://wireadmin.wirelink.com.br/api/registro-leitura/{{$cliente->CdRcd}}/4" alt="" width="1" height="1" style="display: none;">
                                                        Até o momento não identificamos em nossos sistemas o
                                                        pagamento da fatura vencida em
                                                        <b>{{ date( 'd/m/Y' , strtotime($cliente->vencimento))}}</b>
                                                        no valor de <b>R$
                                                            {{number_format($cliente->Valor, 2, ',', '.') }}.</b>
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                <td width="100%" valign="top" align="left">
                                                    <p style="color: rgb(0, 0, 0); font-family: arial, helvetica, sans-serif; font-size: 13px; margin: 0px; line-height: 20px;">
                                                        Evite a suspensão de seus serviços efetuando o pagamento
                                                        ainda hoje. <br>
                                                        Utilize o código de barras abaixo para efetuar o pagamento de seu boleto <br>
                                                        <br>
                                                        Endereço: <strong>{{$cliente->Endereco}},
                                                        </strong> Nº <b>{{$cliente->numero}}</b>, Bairro:
                                                        <b>{{$cliente->Bairro}}</b><br>

                                                        Código de barras: <strong>{{ $cliente->codigo_barras}}</strong><br>
                                                        <br>
                                                ...
                                                <td width="100" valign="middle" align="center">
                                                    <table style="margin: 0px auto; border-collapse: collapse;" width="95" cellspacing="0" cellpadding="0" align="center">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="height: 20px;width: 20px; padding-right: 8px;" align="right" ;><a href="https://www.linkedin.com/company/wirelink-telecom/" target="_blank"><img alt="" style="display: block; height: 20px; width: 20px;" src="{{asset('img/iconLinkedin.png')}}" border="0"></a></td>
                                                                <td style="height: 20px;width: 20px;"><a href="https://www.linkedin.com/company/wirelink-telecom/" target="_blank"><img alt="" style="display: block; height: 20px; width: 20px;" src="{{asset('img/iconFacebook.png')}}" border="0"></a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
